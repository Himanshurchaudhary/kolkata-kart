...
const forgotPassword = async (req, res) => {
    try {
        ...
        await transporter.sendMail({
            from: `"KolkataKart" <${process.env.EMAIL_USER}>`,
            to: user.email,
            subject: 'Reset Your Password — KolkataKart',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 480px; margin: auto; padding: 24px; border: 1px solid #e5e7eb; border-radius: 12px;">
                    <h2 style="color: #16a34a; margin-bottom: 8px;">KolkataKart</h2>
                    ...
                    <p style="color: #9ca3af; font-size: 12px;">© kolkataKart. If the button doesn't work, copy this link: ${resetUrl}</p>
                </div>
            `,
        });
